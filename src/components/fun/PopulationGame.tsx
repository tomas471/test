...
const PopulationGame: React.FC = () => {
  ...
  const handleGuess = (index: 0 | 1) => {
    ...
    const isCorrect =
      countries[index].population >= countries[index === 0 ? 1 : 0].population;
      ...
      <div className="text-center">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">
            You've completed the population challenge!
          </p>
  ...
  return (
    <>
      <SectionTitle
        ...
        subtitle="Which country has a larger population?"
        centered={true}
      />
          ...
          <div className="grid grid-cols-2 gap-8">
            {countries.map((country, index) => (
              <button
                ...
                className="bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-green-500 transition-colors"
